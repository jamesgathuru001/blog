...
class CommentsModelTest(unittest.TestCase):
    ...
    def setUp(self):
       self.new_comment = Comments(id=1, user_id = 2, comment = 'cross buns',blogs_id = '5',date_posted='2019-05-01')
    ...
    def test_comment_variables(self):
       ...
       self.assertEquals(self.new_comment.date_posted,'2019-05-01')
